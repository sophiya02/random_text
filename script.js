...
function printRandom(){
	...
	let paraby=document.getElementById("para-by");
	para.innerHTML=quotes[Math.floor(quotes.length*Math.random())].quote;
	paraby.innerHTML=quotes[Math.floor(quotes.length*Math.random())].source;
}
document.getElementById("btn").addEventListener('click', printRandom);